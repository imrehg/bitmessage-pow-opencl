...
__kernel void bitmessage_pow(__global const sha512_key *password,__global uint64_t *hash, uint64_t start)
{
  ...
  /* printf("output: %lu; nonce: %lu\n", SWAP64(winval), SWAP64(junk[0])); */
